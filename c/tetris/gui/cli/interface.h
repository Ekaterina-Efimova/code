...
void update_display(WINDOW *brick_game_window, game_info_t *game_info);
...
void printf_info(WINDOW *brick_game_window, game_info_t *game_info);
...
void print_result(WINDOW *brick_game_window, game_info_t *game_info);
void print_final_frame(WINDOW *brick_game_window, int i, int j);
void print_final_info(WINDOW *brick_game_window, game_info_t *game_info);
